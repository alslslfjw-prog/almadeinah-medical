...
const iconMap = {
  ...
  'Sparkles': <Sparkles size={40} className="text-white opacity-90" />,
  'Apple': <Apple size={40} className="text-white opacity-90" />,
  'Scissors': <Scissors size={40} className="text-white opacity-90" />,
  'Ribbon': <Ribbon size={40} className="text-white opacity-90" />,
  'Microscope': <Microscope size={40} className="text-white opacity-90" />,
  'Siren': <Siren size={40} className="text-white opacity-90" />,
  'Building2': <Building2 size={40} className="text-white opacity-90" />,
  'Camera': <Camera size={40} className="text-white opacity-90" />,
  'Syringe': <Syringe size={40} className="text-white opacity-90" />,
  'Wind': <Wind size={40} className="text-white opacity-90" />,
  'HeartPulse': <HeartPulse size={40} className="text-white opacity-90" />,
  'Salad': <Salad size={40} className="text-white opacity-90" />,
...
export default function Clinics() {
  // ✅ Replaced inline supabase fetch with useClinics hook
