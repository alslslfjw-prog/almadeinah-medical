...
import { CalendarDays, LayoutDashboard, LogOut, Menu, Receipt, ShieldCheck, User, X } from 'lucide-react';
...
const TABS = [
    ...
    { to: '/dashboard/patient/payments', label: 'المدفوعات', icon: Receipt },
                ...
                <nav className="md:hidden flex border-t border-slate-100">
                    {TABS.map((tab) => (
                        <NavLink
                            ...
                            className={({ isActive }) =>
                                `flex-1 flex flex-col items-center gap-0.5 py-2 text-[10px] font-bold transition ${
